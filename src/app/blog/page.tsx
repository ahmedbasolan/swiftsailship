...
const dispatches = [
  ...
  {
    id: "incoterms-2020-fob-vs-cif-gcc",
    issue: "DISPATCH N° 46",
        ...
        <div className="space-y-12">
          {dispatches.map((dispatch) => (
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl font-serif font-bold text-slate-950 mb-4 hover:text-[#A37F55] transition-colors">
                {dispatch.title}
              </h2>
